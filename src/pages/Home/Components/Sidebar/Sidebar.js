...
function Sidebar(){
    ...
    return(
        <Box sx={{
            ...
            <SidebarOption title={userName} src='https://images.unsplash.com/photo-1541963463532-d68292c34b19?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8Mnx8fGVufDB8fHx8&w=1000&q=80' />
